...
const PROJECTS = [
  {
    ...
    category: "Full Stack",
    desc: "An AI-powered platform that provides intelligent assistance, automation tools, and real-time user interactions through a modern web interface.",
  ...
  },
  {
    ...
    title: "Humanify-ai",
    category: "Frontend",
    desc: "A content humanization tool that transforms AI-generated text into natural, engaging, and human-like writing.",
  ...
  },
  {
    ...
    category: "Full Stack",
    desc: "A social networking platform featuring user profiles, real-time messaging, posts, and interactive community engagement.",
  ...
  },
  {
    ...
    title: "Music Player",
    category: "Backend",
    desc: "A modern music streaming application that allows users to play, manage, and organize their favorite audio tracks.",
  ...
  },
  {
    ...
    title: "To-Do List",
    category: "Frontend",
    desc: "A task management application that helps users organize daily activities, track progress, and boost productivity.",
  ...
  },
  {
    ...
    title: "Quran-AI",
    category: "Backend",
    desc: "An AI-powered Quran assistant that provides verse search, explanations, and intelligent responses to Islamic queries.",
  ...
  },
  {
    ...
    category: "Frontend",
    desc: "A supportive mental wellness platform offering mood tracking, self-care resources, and AI-guided conversations.",
    tech: ["React", "Javascript", "TailwindCSS", "OpenAI"],
    year: "2024",
    color: "#ffffff",
  ...
  },
  {
    ...
    category: "Full Stack",
    desc: "A complete Quranic AI platform integrating authentication, database storage, and intelligent Islamic knowledge assistance.",
    tech: ["React", "Javascript", "TailwindCSS", "OpenAI"],
    year: "2024",
    color: "#ffffff",
